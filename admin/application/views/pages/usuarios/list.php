...
<div class="container mt-5">
        ...
        <div class="d-flex align-items-center">
            ...
            <a class="btn btn-primary btn-lg ms-auto" href="<?php echo site_url('usuarios/create'); ?>">Criar novo usuário</a>
        </div>
